...
const iconMap = {
    ...
    LTCUSD: <Waves size={24} className="text-violet-400-500" />,
    BNBUSD: <CircleDollarSign size={24} className="text-blue-400" />,
    ADAUSD: <CircleDollarSign size={24} className="text-yellow-400" />,
    SOLUSD: <SunDim size={24} className="text-green-500" />,
    DOTUSD: <Orbit size={24} className="text-pink-500" />,
    DOGEUSD: <Orbit size={24} className="text-cyan-500-500" />,
};
